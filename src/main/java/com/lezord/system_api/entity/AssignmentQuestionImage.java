...
import com.lezord.system_api.util.listener.AssignmentQuestionImageListener;
...
@Entity
@Builder
@Table(name = "assignment_question_image")
@EntityListeners(AssignmentQuestionImageListener.class)
public class AssignmentQuestionImage {
    @Id
    ...
    @OneToOne(mappedBy = "assignmentQuestionImage",fetch = FetchType.LAZY)
